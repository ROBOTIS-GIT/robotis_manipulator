...
*****************************************************************************/
// Translation Vector
Eigen::Vector3d robotis_manipulator::math::convertXYZ2Vector(double x, double y, double z)
{
...
//Rotation
Eigen::Matrix3d robotis_manipulator::math::convertRollAngle2RotationMatrix(double angle)
{
...
Eigen::Matrix3d robotis_manipulator::math::convertPitchAngle2RotationMatrix(double angle)
{
  Eigen::Matrix3d rotation(3,3);
  rotation <<
...
Eigen::Matrix3d robotis_manipulator::math::convertYawAngle2RotationMatrix(double angle)
{
  Eigen::Matrix3d rotation(3,3);
  rotation <<
...
Eigen::Vector3d robotis_manipulator::math::convertRotationMatrix2RPYVector(const Eigen::Matrix3d& rotation)
{
...
Eigen::Matrix3d robotis_manipulator::math::convertRPY2RotationMatrix(double roll, double pitch, double yaw)
{
  Eigen::Matrix3d rotation = robotis_manipulator::math::convertYawAngle2RotationMatrix(yaw)*robotis_manipulator::math::convertPitchAngle2RotationMatrix(pitch)*robotis_manipulator::math::convertRollAngle2RotationMatrix(roll);

  return rotation;
}

Eigen::Quaterniond robotis_manipulator::math::convertRPY2Quaternion(double roll, double pitch, double yaw)
{
 Eigen::Quaterniond quaternion;
 quaternion = robotis_manipulator::math::convertRPY2RotationMatrix(roll,pitch,yaw);

 return quaternion;
}

Eigen::Quaterniond robotis_manipulator::math::convertRotationMatrix2Quaternion(const Eigen::Matrix3d& rotation)
{
  Eigen::Quaterniond quaternion;
  quaternion = rotation;
...
Eigen::Vector3d robotis_manipulator::math::convertQuaternion2RPYVector(const Eigen::Quaterniond& quaternion)
{
  Eigen::Vector3d rpy = robotis_manipulator::math::convertRotationMatrix2RPYVector(quaternion.toRotationMatrix());

  return rpy;
}

Eigen::Matrix3d robotis_manipulator::math::convertQuaternion2RotationMatrix(const Eigen::Quaterniond& quaternion)
{
...
Eigen::Vector3d robotis_manipulator::math::convertRotationMatrix2Omega(const Eigen::Matrix3d& rotation_matrix)
{
  return robotis_manipulator::math::matrixLogarithm(rotation_matrix);
}

// Transformation Matrix
Eigen::Matrix4d robotis_manipulator::math::convertXYZRPY2TransformationMatrix(double position_x, double position_y, double position_z , double roll , double pitch , double yaw)
{
  Eigen::Matrix4d transformation = robotis_manipulator::math::convertRPY2TransformationMatrix(roll, pitch, yaw);
...
Eigen::Matrix4d robotis_manipulator::math::convertXYZ2TransformationMatrix(double position_x, double position_y, double position_z)
{
...
Eigen::Matrix4d robotis_manipulator::math::convertRPY2TransformationMatrix(double roll, double pitch, double yaw )
{
...
//Dynamic value
Eigen::Vector3d robotis_manipulator::math::convertOmega2RPYVelocity(Eigen::Vector3d rpy_vector, Eigen::Vector3d omega)
{
...
Eigen::Vector3d robotis_manipulator::math::convertRPYVelocity2Omega(Eigen::Vector3d rpy_vector, Eigen::Vector3d rpy_velocity)
{
  Eigen::Matrix3d c;
...
Eigen::Vector3d robotis_manipulator::math::convertOmegaDot2RPYAcceleration(Eigen::Vector3d rpy_vector, Eigen::Vector3d rpy_velocity, Eigen::Vector3d omega_dot)
{
...
Eigen::Vector3d robotis_manipulator::math::convertRPYAcceleration2OmegaDot(Eigen::Vector3d rpy_vector, Eigen::Vector3d rpy_velocity, Eigen::Vector3d rpy_acceleration)
{
  Eigen::Vector3d c_dot;
  Eigen::Matrix3d c;
